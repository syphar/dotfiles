# Generated by Powerlevel10k configuration wizard on 2019-12-27 at 08:25 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 51917.
# Wizard options: powerline, lean, 1 line, compact, fluent, transient_prompt,
...
() {
  ...
  function prompt_heroku () {
    local app
    app=$(echo ${HEROKU_APP} | sed "s/thermondo-/(t°)-/")

    if [ ! -z $app ]
    then
      p10k segment -f blue -i $'\uE77B' -t "${app}"
    fi
  }
